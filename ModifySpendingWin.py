...
class Ui_ModifySpending(object):
    ...
    def modify(self):
        try:
            self.serv_chel.modifica(self.table.currentRow() + 1,self.doubleSpinBox.value(), self.comboBox.currentText(),self.textEdit.toPlainText())
            self.combo.clear()
    ...
    def retranslateUi(self, AddSpending):
        ...
        AddSpending.setWindowTitle(_translate("ModifySpending", "Modify spending"))
        self.label.setText(_translate("ModifySpending", "Budget:"))
        self.label_2.setText(_translate("ModifySpending", "Category:"))
        self.label_3.setText(_translate("ModifySpending", "Description:"))
        self.pushButton.setText(_translate("ModifySpending", "Modify"))
